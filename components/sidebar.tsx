...
export default function Sidebar({ currentPage, onNavigate, userInfo, onLogout }: SidebarProps) {
  const allMenuItems = [
    { id: "dashboard", label: "Dashboard", icon: "📊", access: "dashboard" },
    { id: "entry", label: "Data Entry", icon: "📝", access: "data entry" },
    { id: "records", label: "View Records", icon: "📋", access: "records" },
  ]
    ...
    <div className="w-64 bg-gradient-to-b from-blue-900 to-blue-800 text-white flex flex-col shadow-xl">
      ...
      <div className="p-4 border-t border-blue-700">
        {onLogout && (
          <button
            onClick={onLogout}
            className="w-full bg-red-600 hover:bg-red-700 text-white py-2 px-4 rounded-lg transition duration-300 mb-3"
          >
            Logout
          </button>
        )}
